...
const ArtistPiercerMain = () => {
  // Accordion data
  const accordionItems = [
    {
      question: "How do I book an appointment?",
      answer: "You can book an appointment by calling, emailing, or visiting our studio. We also offer walk-ins based on artist availability.There is a dedicated booking page where you might fill in your details like name, email, phone number and we'll be more than glad to get back to you"
    },
    {
    ...
    },
    {
      ...
      answer: "Pricing varies depending on size, detail, placement, and the amount of time dedicated for the body art of choice, we are more open to share our rate card with you after communication with our prospectives. we also provide free consultations and quotes."
    },
    {
...
export default ArtistPiercerMain;