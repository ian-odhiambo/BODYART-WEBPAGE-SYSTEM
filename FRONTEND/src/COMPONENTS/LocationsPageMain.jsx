...
const LocationsPageMain = () => {
  const accordionItems = [
    {
      question: "How do I book an appointment?",
      answer: "You can book an appointment by calling, emailing, or visiting our studio. We also offer walk-ins based on artist availability."
    },
    {
    ...
    },
    {
      ...
      answer: "Pricing varies depending on size, detail, placement, and artist. Most shops have minimums ($50-$100) and hourly rates ($150-$300). We provide free consultations and quotes."
    },
    {
...
export default LocationsPageMain;
