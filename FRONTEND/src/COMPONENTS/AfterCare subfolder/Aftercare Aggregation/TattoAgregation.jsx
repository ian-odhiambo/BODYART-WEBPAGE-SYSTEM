import TatCareHero from '../tattoo/TatCareHero';
import TattooGuideline from '../tattoo/TattooGuideline';
import TattooAccordion from '../tattoo/TattooAccordion';
import TattooGuideline2 from '../tattoo/TattooGuideline2';
import CallToAction from '../../Default subcomponents/CallToAction';

const TattoAgregation = () => {
...
export default TattoAgregation